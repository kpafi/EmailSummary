...
| F-ING-2 | Jede Mail wird genau einmal verarbeitet (Dedupe über Message-ID **und** einen Inhalts-Hash, persistenter State). „Genau einmal" gilt je Mail, nicht je Message-ID: Zwei inhaltlich verschiedene Mails mit demselben Header sind eine Kollision und werden beide verarbeitet (ADR-079). | abgeleitet | done (WP2, erweitert Fixrunde HC-10) |
